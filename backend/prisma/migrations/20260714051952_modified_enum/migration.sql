/*
  ...
  - The values [PROCESSING,AI_ANALYZING,PR_CREATED] on the enum `IncidentStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "IncidentStatus_new" AS ENUM ('RECEIVED', 'QUEUED', 'COLLECTING_CONTEXT', 'ANALYZING', 'VALIDATING', 'READY', 'FAILED', 'COMPLETED');
